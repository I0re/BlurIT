    ...
    foreach (icon ${ARG_ICONS})
		...
		if (APPLE)
			if (${icon_type} STREQUAL ".icns")
				set(icon_full_output ${CMAKE_CURRENT_BINARY_DIR}/Assets/${icon_name}.icns)
				file(COPY ${icon_full} DESTINATION ${CMAKE_CURRENT_BINARY_DIR}/Assets/)
		...
		if (WIN32)        
			if (${icon_type} STREQUAL ".ico")
				set(icon_full_output ${CMAKE_CURRENT_BINARY_DIR}/Assets/${icon_name}.ico)
				file(COPY ${icon_full} DESTINATION ${CMAKE_CURRENT_BINARY_DIR}/Assets/)
				file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/Assets/${icon_name}.rc.in" "IDI_ICON1        ICON        DISCARDABLE    \"${icon_name}.ico\"\n")
				add_custom_command(
						OUTPUT "${icon_name}.rc"
